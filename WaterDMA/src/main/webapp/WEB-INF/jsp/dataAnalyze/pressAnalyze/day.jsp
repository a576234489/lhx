...
<div class="ui-layout" id="layout" style="height: 100%; width: 100%;">
    ...
    <div class="ui-layout-center">
        <div class="center-Panel">
            <div class="panel-Title">日压力分析</div>
...
<script>
    ...
    function GetGrid() {
        ...
        function SearchEvent() {
            ...
            $.ajax({
                url: "../../PressAnalyze/AnalyzePressDay/GetGridColumnJson",
    ...
    function GetGridColumns(resultObj) {
        ...
        $gridTable.jqGrid({
            url: "../../PressAnalyze/AnalyzePressDay/GetReportJson",
    ...
    function LoadChart() {
        ...
        queryJson["SpanNumber"] = $("#queryCondition .dropdown-text").attr('data-value');
        $.ajax({
            url: "../../PressAnalyze/AnalyzePressDay/GetChartJson",
            data: { queryJson: JSON.stringify(queryJson) },
            type: "post",
            dataType: "text",
