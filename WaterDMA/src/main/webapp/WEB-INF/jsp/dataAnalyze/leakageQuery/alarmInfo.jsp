...
<script>
    ...
    function GetGrid() {
        ...
        var queryJson = $("#filter-form").GetWebControls();
        $gridTable.jqGrid({
            url: "../../LeakageQuery/AlarmInfo/GetPageListJson",
            postData: { queryJson: JSON.stringify(queryJson) },
            datatype: "json",
            height: $(window).height() - 136.5,
            autowidth: true,
            colModel: [
                { name: 'AlarmId', label: '主键', hidden: true },
                ...
                { name: "P_AlarmType", label: "告警类型", width: 120, align: 'left' },
                { name: "CreateTime", label: "告警发生时间", width: 140, align: "right" },
                { name: "P_AlarmMessage", label: "告警信息", width: 200, align: 'left' }
            ],
            viewrecords: true,
            rowNum: 20,
