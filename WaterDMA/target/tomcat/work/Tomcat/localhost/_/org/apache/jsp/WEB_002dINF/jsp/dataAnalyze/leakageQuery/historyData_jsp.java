 ...
 * Generated at: 2018-05-15 05:34:33 UTC
 * Note: The last modified time of this file was set to
 *       the last modified time of the source file after
 *       generation to assist with modification tracking.
 */
package org.apache.jsp.WEB_002dINF.jsp.dataAnalyze.leakageQuery;

import javax.servlet.*;
import javax.servlet.http.*;
import javax.servlet.jsp.*;

public final class historyData_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("                    <div id=\"MeterList\" style=\"width: 200px;\" type=\"select\" class=\"ui-select\" >\r\n");
      out.write("                    </div>\r\n");
      out.write("                </td>\r\n");
      out.write("                <td style=\"padding-left: 10px;\">日期：</td>\r\n");
      out.write("                <td style=\"padding-left: 10px;\">\r\n");
      ...
      out.write("                                <tr>\r\n");
      out.write("                                    <th class=\"formTitle\">查询时间段：</th>\r\n");
      out.write("                                    <td class=\"formValue\">\r\n");
      out.write("                                        <input type=\"hidden\" id=\"MeterId\" />\r\n");
      ...
      out.write("        });\r\n");
      out.write("        //监测点列表\r\n");
      out.write("        $(\"#MeterList\").ComboBox({\r\n");
      out.write("            url: \"../../LeakageConfig/MeterInfoManage/GetListJson\",\r\n");
      out.write("            id: \"MeterId\",\r\n");
      out.write("            text: \"M_Name\",\r\n");
      out.write("            description: \"==请选择==\",\r\n");
      out.write("            height: \"250px\",\r\n");
      out.write("            allowSearch: true\r\n");
      out.write("        }).bind(\"change\", function () {\r\n");
      out.write("            $(\"#MeterId\").val($(this).attr('data-value'));\r\n");
      ...
      out.write("            url: \"../../LeakageQuery/HistoryData/GetPageListJson\",\r\n");
      out.write("            postData: { queryJson: JSON.stringify(queryJson) },\r\n");
      ...
      out.write("                { name: 'M_Name', label: '站点名称', width: 160, align: 'left' },\r\n");
      out.write("                { name: 'M_PipeDn', label: '管径大小', width: 80, align: 'left' },\r\n");
      out.write("                { name: 'M_Material', label: '管线材质', width: 80, align: 'left' },\r\n");
      out.write("                { name: 'M_InstallAddress', label: '安装地址', width: 200, align: 'left' },\r\n");
      out.write("                { name: \"RealValue\", label: \"瞬时流量（m³/h)\", width: 125, align: \"right\", formatter: 'number', formatoptions: { thousandsSeparator: \"\", decimalPlaces: 2 } },\r\n");
      out.write("                { name: \"ForValue\", label: \"正向累计流量（m³)\", width: 130, align: \"right\", formatter: 'number', formatoptions: { thousandsSeparator: \"\", decimalPlaces: 2 } },\r\n");
      out.write("                { name: \"RevValue\", label: \"反向累计流量（m³)\", width: 130, align: \"right\", formatter: 'number', formatoptions: { thousandsSeparator: \"\", decimalPlaces: 2 } },\r\n");
      out.write("                { name: \"PressValue\", label: \"管道压力（Mpa)\", width: 110, align: \"right\", formatter: 'number', formatoptions: { thousandsSeparator: \"\", decimalPlaces: 2 } },\r\n");
      out.write("                { name: \"CelVal\", label: \"电池电压（V)\", width: 110, align: \"right\", formatter: 'number', formatoptions: { thousandsSeparator: \"\", decimalPlaces: 2 } },\r\n");
      out.write("                { name: \"CreateTime\", label: \"采集时间\", width: 120, align: \"right\" }\r\n");
      out.write("            ],\r\n");
      out.write("            viewrecords: true,\r\n");
      out.write("            rowNum: 20,\r\n");
      out.write("            rowList: [10, 20, 30, 50, 100],\r\n");
      out.write("            pager: \"#gridPager\",\r\n");
      out.write("            sortname: 'CreateTime DESC',\r\n");
      ...
      out.write("            $(\"#MeterId\").val($(\"#MeterList\").attr('data-value'));\r\n");
      out.write("            var queryJson = $(\"#filter-form\").GetWebControls();\r\n");
      out.write("            $(\"#gridTable\").jqGrid('setGridParam', {\r\n");
      out.write("                postData: { queryJson: JSON.stringify(queryJson) },\r\n");
      out.write("                page: 1\r\n");
