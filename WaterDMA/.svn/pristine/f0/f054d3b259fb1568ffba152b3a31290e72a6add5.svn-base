...
loadnav = function () {
    ...
    $("#HomePage").click(function () {
        tablist.newTab({ id: 'desktop', title: '欢迎首页', closed: false, icon: 'fa fa fa-desktop', url: '/home/adminDefaultDesktop' });
    });
    //个人中心
    $("#UserSetting").click(function () {
        tablist.newTab({ id: "UserSetting", title: "个人中心", closed: true, icon: "fa fa fa-user", url: "/personCenter" });
    });
    //动态加载导航菜单
    var _html = "";
    var index = 0;
    ...
    $('#nav li a').click(function () {
        ...
        if (data.Target === "iframe") {
            ...
            tablist.newTab({ id: "menu", title: "查看菜单", closed: true, icon: "fa fa fa-user", url: "/home/menu" });
        }
    });
    ...
    function getsubnav(moduleId) {
        ...
        var temp = authorizeMenuData.concat();
        temp.splice(12, 1);
