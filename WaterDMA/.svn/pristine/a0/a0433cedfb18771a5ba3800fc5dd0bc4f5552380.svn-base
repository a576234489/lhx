...
<div class="ui-layout" id="layout" style="height: 100%; width: 100%;">
    ...
    <input type="hidden" id="hiddenMeterId" />
    <div class="ui-layout-center">
        <div class="center-Panel">
            <div class="panel-Title">月压力分析</div>
                        ...
                        <tr>
                            ...
                            <td style="padding-left: 5px;" id="filter-div">
                                <div style="float: left; width: 100px;">
                                    <input id="StartTime" readonly type="text" value="2018-04-01"
                            ...
                            <td style="padding-left: 5px;">
                                <div id="queryCondition" class="btn-group">
                                    <a class="btn btn-default dropdown-text" data-value="1" data-toggle="dropdown">1日</a>
                                    <a class="btn btn-default dropdown-toggle" data-toggle="dropdown"><span class="caret"></span></a>
                                    <ul class="dropdown-menu">
                                        <li><a data-value="1">1日</a></li>
                                        <li><a data-value="2">2日</a></li>
                                        <li><a data-value="3">3日</a></li>
                                        <li><a data-value="5">5日</a></li>
                                        <li><a data-value="6">6日</a></li>
                                        <li><a data-value="8">8日</a></li>
                                    </ul>
                                </div>
                            </td>
                            <td style="padding-left: 5px;">
...
<script>
    ...
    function GetGrid() {
        ...
        $gridTable.jqGrid({
            ...
            colModel: [
                { name: '时间', label: '日期', width: 130, align: 'left' },
            ],
            viewrecords: true,
            rowNum: 50,
        ...
        function SearchEvent() {
            ...
            $.ajax({
                url: "../../PressAnalyze/AnalyzePressMonth/GetGridColumnJson",
    ...
    function GetGridColumns(resultObj) {
        ...
        $gridTable.jqGrid({
            url: "../../PressAnalyze/AnalyzePressMonth/GetReportJson",
    ...
    require.config({
        paths: {
            echarts: '/static/scripts/plugins/echarts'
        }
    });
    // 使用
    require(
    ...
    function LoadChart() {
        if (MeterId.indexOf("_") < 1) {
            dialogMsg('请先在左边监控站点列表中，选择一个统计图表的站点！', 0);
            return;
        }
        ...
        var queryJson = $("#filter-div").GetWebControls();
        queryJson["MeterId"] = MeterId;
        queryJson["StartTime"] = $("#StartTime").val();
        queryJson["SpanNumber"] = $("#queryCondition .dropdown-text").attr('data-value');
        $.ajax({
            url: "../../PressAnalyze/AnalyzePressMonth/GetChartJson",
            data: { queryJson: JSON.stringify(queryJson) },
            type: "post",
            dataType: "text",
