...
<div class="ui-layout" id="layout" style="height: 100%; width: 100%;">
    ...
    <div class="ui-layout-center">
        <div class="center-Panel">
            <div class="panel-Title">最小夜间流量分析</div>
...
<script>
    ...
    function GetGrid() {
        ...
        queryJson["AreaId"] = AreaId;
        $gridTable.jqGrid({
            url: "../../LeakageAnalyze/NightFlowAnalyze/GetPageListJson",
            postData: { queryJson: JSON.stringify(queryJson) },
            datatype: "json",
    ...
    function LoadChart() {
        ...
        $.ajax({
            url: "../../LeakageAnalyze/NightFlowAnalyze/GetChartJson",
